...
func (k *Kubernetes) WatchNamespaces() (watch.Interface, error) {
	w, err := k.ClientSet.CoreV1().Namespaces().Watch(context.TODO(), metav1.ListOptions{})
	return w, errors.Wrapf(err, "unable to get namespaces watcher")
}
